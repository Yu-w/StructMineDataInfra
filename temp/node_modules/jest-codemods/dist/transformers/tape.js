...
const tPropertiesUnsupported = new Set(['timeoutAfter',
...
function tapeToJest(fileInfo, api, options) {
    ...
    const testFunctionName = (0, _imports.removeRequireAndImport)(j, ast, 'tape');
    ...
    const transforms = [() => (0, _tapeAvaHelpers.rewriteDestructuredTArgument)(fileInfo, j, ast, testFunctionName), () => (0, _tapeAvaHelpers.detectUnsupportedNaming)(fileInfo, j, ast, testFunctionName), function detectUnsupportedFeatures() {
        ...
        ast.find(j.CallExpression, {
            ...
            if (newPropertyName === SPECIAL_THROWS_CASE) {
                ...
                if (noErrorType) {
                    ...
                    newCondition = j.callExpression(j.identifier('toThrowError'), [args[1]]);
                }
