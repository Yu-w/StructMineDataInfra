...
class TreeList extends Component {
  ...
  handleTouchTap(listItem, index, isRightIcon) {
    if (isRightIcon) {
      this.props.handleTouchTap && this.props.handleTouchTap(listItem, index, true);
      return;
    }
    ...
    if (this.searchMode && this.props.handleTouchTapInSearchMode) this.props.handleTouchTapInSearchMode(listItem, index, false)
    if (!this.searchMode && this.props.handleTouchTap) this.props.handleTouchTap(listItem, index, false)
  }
  ...
  render() {
    ...
    .map((listItem, i) => {
      if (listItem._shouldRender) {
        return (
          <ListItem
            ...
            rightIcon={
              <FlatButton
                icon={<CheckIcon viewBox="0 0 24 32"/>}
                style={{heigth: 44}}
                onClick={() => this.handleTouchTap(listItem, i, true)}
              />
            }
            leftIcon={!listItem.children
              ? null
            ...
            onClick={()=> {
              ...
              this.handleTouchTap(listItem, i, false)
            }}
          />
      ...
      TreeList.propTypes = {
        ...
        handleTouchTapOnRightIcon: PropTypes.func,
